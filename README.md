...
🐍 Focada em desenvolvimento Back-End com Python (Django) e aplicações web  

---

Gosto de transformar ideias em código e entender como as coisas funcionam por trás da tela.  
Atualmente, estou focada no desenvolvimento back-end com Python (Django), criando aplicações web e evoluindo por meio de projetos práticos.  
